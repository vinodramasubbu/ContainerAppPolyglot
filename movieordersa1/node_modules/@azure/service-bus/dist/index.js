 ...
 * @internal
 */
function createReceiverOptions(name, receiveMode, source, clientId, handlers) {
    const rcvrOptions = Object.assign({ name, 
        ...
        snd_settle_mode: receiveMode === "receiveAndDelete" ? 1 : 0, source, target: clientId, credit_window: 0, properties: { [coreAmqp.Constants.receiverIdentifierName]: clientId } }, handlers);
    return rcvrOptions;
}
...
class ServiceBusReceiverImpl {
     ...
     */
    constructor(_context, entityPath, receiveMode, maxAutoRenewLockDurationInMs, skipParsingBodyAsJson, retryOptions = {}, identifier) {
        this._context = _context;
        this.entityPath = entityPath;
    ...
    subscribe(handlers, options) {
        ...
        this._streamingReceiver =
            (_b = this._streamingReceiver) !== null && _b !== void 0 ? _b : new StreamingReceiver(this.identifier, this._context, this.entityPath, Object.assign(Object.assign({}, options), { receiveMode: this.receiveMode, retryOptions: this._retryOptions, lockRenewer: this._lockRenewer, skipParsingBodyAsJson: this.skipParsingBodyAsJson }));
...
class ServiceBusSenderImpl {
    ...
    async sendMessages(messages, options) {
        ...
        if (!isServiceBusMessageBatch(messages) && !Array.isArray(messages)) {
            ...
            return tracingClient.withSpan("ServiceBusSender.send", options !== null && options !== void 0 ? options : {}, (updatedOptions) => this._sender.send(messages, updatedOptions), Object.assign({}, toSpanOptions({ entityPath: this.entityPath, host: this._context.config.host }, "client")));
        }
        let batch;
...
class MessageSession extends LinkEntity {
     ...
     * Creates the options that need to be specified while creating an AMQP receiver link.
     */
    _createMessageSessionOptions(clientId) {
...
class ServiceBusClient {
    ...
    options3) {
        ...
        const maxLockAutoRenewDurationInMs = (options === null || options === void 0 ? void 0 : options.maxAutoLockRenewalDurationInMs) != null
            ? options.maxAutoLockRenewalDurationInMs
            : 5 * 60 * 1000;
        return new ServiceBusReceiverImpl(this._connectionContext, entityPathWithSubQueue, receiveMode, maxLockAutoRenewDurationInMs, (_a = options === null || options === void 0 ? void 0 : options.skipParsingBodyAsJson) !== null && _a !== void 0 ? _a : false, this._clientOptions.retryOptions, options === null || options === void 0 ? void 0 : options.identifier);
    }
    /**

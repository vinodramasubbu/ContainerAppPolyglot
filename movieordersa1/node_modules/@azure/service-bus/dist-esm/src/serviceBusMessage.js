 ...
 */
export function fromRheaMessage(rheaMessage, skipParsingBodyAsJson, delivery, shouldReorderLockToken) {
    var _a, _b;
    if (!rheaMessage) {
        rheaMessage = {
            body: undefined,
...
export class ServiceBusMessageImpl {
    ...
    constructor(msg, delivery, shouldReorderLockToken, receiveMode, skipParsingBodyAsJson) {
        const _a = fromRheaMessage(msg, skipParsingBodyAsJson, delivery, shouldReorderLockToken), { _rawAmqpMessage } = _a, restOfMessageProps = __rest(_a, ["_rawAmqpMessage"]);

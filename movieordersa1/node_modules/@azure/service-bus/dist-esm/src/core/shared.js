 ...
 * @internal
 */
export function createReceiverOptions(name, receiveMode, source, clientId, handlers) {
    const rcvrOptions = Object.assign({ name, 
        ...
        snd_settle_mode: receiveMode === "receiveAndDelete" ? 1 : 0, source, target: clientId, credit_window: 0, properties: { [Constants.receiverIdentifierName]: clientId } }, handlers);
    return rcvrOptions;
}

...
var _setupString = JsonConfig_1.JsonConfig.getInstance().connectionString || process.env.APPINSIGHTS_INSTRUMENTATIONKEY;
 ...
 */
function setupAndStart(setupString, aadTokenCredential) {
